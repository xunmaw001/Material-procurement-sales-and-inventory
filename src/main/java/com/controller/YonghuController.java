...
//        if(StringUtil.isNotEmpty(role) && "商品管理员".equals(role)){
//            params.put("roleTypes",2);//商品管理员
//        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String roleTypes = role_types.get(yonghu.getRoleTypes());
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", roleTypes);
        R r = R.ok();
        r.put("token", token);
        r.put("role",roleTypes);
