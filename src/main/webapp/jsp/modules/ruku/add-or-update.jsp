            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑入库订单</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="gongyingshangId" name="gongyingshangId" type="hidden">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="rukuNumber" name="rukuNumber" class="form-control"
                                               onchange="rukuNumberChickValue(this)"  placeholder="入库数量">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#gongyingshangId") !=null){
            ...
            httpJson("ruku/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    // 获取当前详情
    function getDetails() {
        var addruku = window.sessionStorage.getItem("addruku");
        if (addruku != null && addruku != "" && addruku != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("ruku/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#rukuNumber").val(ruleForm.rukuNumber);
