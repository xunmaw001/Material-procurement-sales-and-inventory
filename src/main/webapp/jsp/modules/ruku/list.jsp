        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">入库订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">入库订单管理</li>
                            <li class="breadcrumb-item active">入库订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">入库订单列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="rukuNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="rukuNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="rukuNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="rukuNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongyingshangNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="供应商名" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        供应商类型
                                        <div class="layui-input-inline">
                                            <select name="gongyingshangTypesSelectSearch"  style="width: 150px;" id="gongyingshangTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(danjiaEndSearchInput != null){
                ...
                //入库数量
            var rukuNumberStartSearchInput = $('#rukuNumberStartSearch');
            if(rukuNumberStartSearchInput != null){
                var rukuNumberStartSearchValue = rukuNumberStartSearchInput.val();
                if( rukuNumberStartSearchValue  != 0){
                    searchForm.rukuNumberStart = rukuNumberStartSearchValue;
                }
            }
            var rukuNumberEndSearchInput = $('#rukuNumberEndSearch');
            if(rukuNumberEndSearchInput != null){
                var rukuNumberEndSearchValue = rukuNumberEndSearchInput.val();
                if( rukuNumberEndSearchValue  != 0){
                    searchForm.rukuNumberEnd = rukuNumberEndSearchValue;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("ruku/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                rukuNumberStart: searchForm.rukuNumberStart,
                rukuNumberEnd: searchForm.rukuNumberEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(gongyingshangTypesCell);
                    ...
                    //供应商详情
            var gongyingshangContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.gongyingshangContent && item.gongyingshangContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.gongyingshangContent.indexOf('<img');
                var endIndex = item.gongyingshangContent.indexOf('>');
                    gongyingshangContentCell.innerHTML = item.gongyingshangContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.gongyingshangContent != null && item.gongyingshangContent != "" && item.gongyingshangContent.length >= 11) {
                        gongyingshangContentCell.innerHTML = item.gongyingshangContent.substring(0, 10) + "...";
                } else {
                        gongyingshangContentCell.innerHTML = item.gongyingshangContent;
                }
            }
            row.appendChild(gongyingshangContentCell);
            ...
            //入库数量
            var rukuNumberCell = document.createElement('td');
            rukuNumberCell.innerHTML = item.rukuNumber;
            row.appendChild(rukuNumberCell);
            ...
            // 整数
            function rukuNumberChickValue(e){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("ruku/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addruku", "addruku");
            window.location.href = "add-or-update.jsp"
        }
