        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">销售订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">销售订单管理</li>
                            <li class="breadcrumb-item active">销售订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">销售订单列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="xiaoshouNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="xiaoshouNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="xiaoshouNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="xiaoshouNumberChickValue(this)"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( kehuIdNumberSearchInput != null){
                ...
                //销售数量
            var xiaoshouNumberStartSearchInput = $('#xiaoshouNumberStartSearch');
            if(xiaoshouNumberStartSearchInput != null){
                var xiaoshouNumberStartSearchValue = xiaoshouNumberStartSearchInput.val();
                if( xiaoshouNumberStartSearchValue  != 0){
                    searchForm.xiaoshouNumberStart = xiaoshouNumberStartSearchValue;
                }
            }
            var xiaoshouNumberEndSearchInput = $('#xiaoshouNumberEndSearch');
            if(xiaoshouNumberEndSearchInput != null){
                var xiaoshouNumberEndSearchValue = xiaoshouNumberEndSearchInput.val();
                if( xiaoshouNumberEndSearchValue  != 0){
                    searchForm.xiaoshouNumberEnd = xiaoshouNumberEndSearchValue;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("xiaoshou/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                xiaoshouNumberStart: searchForm.xiaoshouNumberStart,
                xiaoshouNumberEnd: searchForm.xiaoshouNumberEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //销售数量
            var xiaoshouNumberCell = document.createElement('td');
            xiaoshouNumberCell.innerHTML = item.xiaoshouNumber;
            row.appendChild(xiaoshouNumberCell);
            ...
            // 整数
            function xiaoshouNumberChickValue(e){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xiaoshou/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxiaoshou", "addxiaoshou");
            window.location.href = "add-or-update.jsp"
        }
